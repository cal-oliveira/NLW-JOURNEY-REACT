    ...
    <div className="bg-pattern h-screen bg-no-repeat bg-center flex items-center justify-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="space-y-4">
          ...
          {guestsInput && <GuestsInput openGuestsModal={openGuestsModal} />}
        </div>
            ...
            <div className='space-y-3'>
              <div className='space-y-2'>
                <div className='bg-zinc-950 rounded-lg flex items-center gap-2.5 px-4 border border-zinc-800'>
                  ...
                  <input className='h-14 bg-transparent' placeholder='Seu nome completo' type="text" />
                </div>
                <div className='bg-zinc-950 rounded-lg flex items-center gap-2.5 px-4 border border-zinc-800'>
                  <Mail className='text-zinc-400 size-5'/>
                  <input className='h-14 bg-transparent' placeholder='Seu e-mail pessoal' type="text" />
                </div>
              </div>

              <button type='submit' className="bg-lime-300 text-lime-950 font-medium flex items-center justify-center gap-2 w-full px-5 py-2 rounded-lg hover:bg-lime-700">
                Confirmar criação da viagem
              </button>
            </div>
          </div>
